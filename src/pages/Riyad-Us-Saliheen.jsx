...
import objectList from "@/data/RSSData.json";
import titles from "@/data/chapterNamesRSS.json";
...
function RiyardUsSaliheen() {
  return (
    <div className="bg-neutral-800 text-neutral-50 min-h-screen">
      <Banner>Riyard-us-Saliheen</Banner>
...
export default RiyardUsSaliheen;
